...
<body>
    ...
    <div class="container">
        <div class="section">
            ...
            <p>Nasz salon prowadzony jest prowadzony z pasją przez wyszkolonych profesjonalistów. Oferujemy wszelkiego rodzaju usługi kosmetyczne.</p>
        </div>
        <div class="section">
            <h2>Nasze usługi</h2>
            <ul>
