...
Route::middleware(['auth', 'role:admin'])->group(function () {
    Route::get('/admin', [AdminController::class, 'index'])->withoutMiddleware([\App\Http\Middleware\CheckHoliday::class])->name('admin.dashboard');
    ...
    Route::delete('/admin/holidays/{id}', [HolidayController::class, 'destroy'])->name('admin.holidays.destroy');
});
