        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <a class="nav-link" href="/admin">Panel Główny</a>
                    <li><a class="nav-link" href="<?php echo e(route('admin.reviews.index')); ?>">Recenzje</a></li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('admin.holidays.index')); ?>">Dni wolne</a></li>
                </ul>
...
<?php /**PATH C:\xampp\htdocs\KosmetycznySalon_21296\resources\views/layouts/admin.blade.php ENDPATH**/ ?>