...
<body>
    <div class="container text-center mt-5">
        <h1>Witamy w Systemie Rezerwacji Wizyt Salonu Kosmetycznyego!</h1>
        <p class="lead">Skorzystaj z naszych usług już dziś, dzięki szybkiej możliwości rezerwacji!</p>
        <a href="<?php echo e(route('login-form')); ?>" class="btn btn-primary">Zaloguj się aby zobaczyć dostępne wizyty</a>
        <a href="<?php echo e(route('register-form')); ?>" class="btn btn-primary">Zarejestruj się</a>
    </div>
...
<?php /**PATH C:\xampp\htdocs\KosmetycznySalon_21296\resources\views/welcome.blade.php ENDPATH**/ ?>