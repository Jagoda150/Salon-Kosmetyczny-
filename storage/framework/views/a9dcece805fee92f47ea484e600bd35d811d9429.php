...
<?php $__env->startSection('title', 'Dodaj Pracownika'); ?>
...
<div class="container">
    ...
    <br>
    <a href="<?php echo e(url('/admin')); ?>" class="btn btn-secondary">Powrót</a>
    <div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\salonf_ostateczny-main\resources\views/admin/add-employee.blade.php ENDPATH**/ ?>