...
<div class="position-fixed bottom-0 end-0 m-3">
    ...
    <div class="container mt-5">
        ...
        <form action="<?php echo e(route('client.appointments.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#appointment_date, #employee_id').on('change', function () {
                ...
                if (date && employeeId) {
                    $.ajax({
                        url: "<?php echo e(route('client.appointments.create')); ?>",
                        method: "GET",
...
<?php /**PATH C:\xampp\htdocs\KosmetycznySalon_21296\resources\views/client/appointments/create.blade.php ENDPATH**/ ?>